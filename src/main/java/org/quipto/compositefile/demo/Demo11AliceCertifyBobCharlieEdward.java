 ...
 */
public class Demo11AliceCertifyBobCharlieEdward
{
  static final DemoUtils.DemoUser[] subjectdemousers = { BOB, CHARLIE, EDWARD };
  static final boolean[] addtoteam  = { true,  true,  true };
  static final boolean[] controller = { true,  false, true };
  static final boolean[] isparent   = { false, false, false };
