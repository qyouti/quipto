 ...
 */
public class Demo32DebbieCertifyBob
{
  static final DemoUtils.DemoUser[] subjectdemousers = { BOB };
          ...
          throws Exception
  {
    ...
    SignKeys.signKeysAndImport(DEBBIE, passhandler, false, subjectdemousers, addtoteam, null, null );
  }
}
